...
DndClass.all.each do |dc|
  20.times do |c|
    ...
    new_level = DndClassLevel.create!(
      ...
      martial_arts_dice_count: specifics["martial_arts_dice_count"] ? specifics["martial_arts_dice_count"] : nil,
      martial_arts_dice_value: specifics["martial_arts_dice_value"] ? specifics["martial_arts_dice_value"] : nil,
      ...
      sneak_attack_dice_count: specifics["sneak_attack_dice_count"] ? specifics["sneak_attack_dice_count"] : nil,
      sneak_attack_dice_value: specifics["sneak_attack_dice_value"] ? specifics["sneak_attack_dice_value"] : nil,
