class DndClassSerializer < ActiveModel::Serializer
  ...
  def levels
    self.object.dnd_class_levels.map { |lvl| 
      ...
      bard_level = {baric_inspiration_die: lvl[:baric_inspiration_die], song_of_rest_die: lvl[:song_of_rest_die],magical_secrets_max_5: lvl[:magical_secrets_max_5],magical_secrets_max_7: lvl[:magical_secrets_max_7],magical_secrets_max_9: lvl[:magical_secrets_max_9]}
